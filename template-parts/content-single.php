...
<div class="post post-<?php the_ID(); ?>">
    ...
    if ($downloadlink) : ?>
        <a class="btn btn-download" href="#download-<?php the_ID(); ?>" rel="modal:open">Download Now</a>
        <div id="download-<?php the_ID(); ?>" class="modal">
            <div class="modal-dialog">
                <div class="modal-content">
                    <h3 class="modal-title">Please enter your valid name & email address.</h3>
                    <?php echo do_shortcode('[email-download-link namefield="YES" id="' . $downloadlink . '"]'); ?>
                </div>
            </div>
        </div>
    <?php endif;
